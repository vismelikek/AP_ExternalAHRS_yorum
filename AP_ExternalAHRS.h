...
#pragma once //header dosyası bi kere eklensin diye

#include "AP_ExternalAHRS_config.h" //bununn içinde AP_EXTERNALAHRS klasörünün bütün makroları duruyo

#if HAL_EXTERNAL_AHRS_ENABLED //AP_ExternalAHRS_config.h da HAL_EXTERNAL_AHRS_ENABLED tanımlandıysa bu kod çalıştırılıyo

// "/" o kütüphanenin hangi klasörde olduğunu belirtmek içinmiş

#include <AP_HAL/AP_HAL.h> //hal.h ve param.h allahın emri yani hep ekleniyo da hangi satırlar bizi ilgilendiriyomuş sonra bakıcam
#include <AP_Param/AP_Param.h>
#include <AP_Common/Location.h> //burda uçağın konum değişkenlerin tanımlaması yapılıyo (lat lng nedir birimi fln), detaylı okumak gerekebilir bakıcaz
#include <AP_NavEKF/AP_Nav_Common.h>  //EKF yle ilgili bi lib, gerekince bakıcam
